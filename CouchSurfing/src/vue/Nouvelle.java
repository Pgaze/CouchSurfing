...
public class Nouvelle extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FormulaireProposerLogement form=new FormulaireProposerLogement(request.getParameter("batimentEscalier"), request.getParameter("numeroEtVoie"), request.getParameter("cp"), request.getParameter("residence"), request.getParameter("complementAdresse"), request.getParameter("ville"), user);
